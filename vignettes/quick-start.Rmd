...
This guide is intended to briefly demonstrate the basic usage of `visreg`.  For more details, see the documentation (`?visreg`, `?plot.visreg`, and `?visreg2d`), as well as

* [The visreg homepage](http://pbreheny.github.io/visreg), which provides many more examples of how to use the software.
