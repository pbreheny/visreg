...
visreg2d <- function(fit,x,y,fill=c("mean","zero","median"),type=c("response","terms"),res=ifelse(plot.type=="persp",49,99),plot.type=c("image","persp","rgl"),trans=as.matrix,cond=list(),...)
  {
