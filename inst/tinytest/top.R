...
# ggplot
p <- visreg(fit, "A", "B", top = "points", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "A", "B", top = "line", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "B", "A", top = "points", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "B", "A", top = "line", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "A", top = "points", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "A", top = "line", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "B", top = "points", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
p <- visreg(fit, "B", top = "line", gg = TRUE, points.par = list(size = 2))
print(p) |> expect_silent()
