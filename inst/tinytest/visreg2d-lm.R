...
p <- visreg2d(fit, x = "Wind", y = "Temp", plot.type = "gg")
...
p <- visreg2d(fit, x = "Wind", y = "Temp", type = "contrast", plot.type = "gg")
print(p) |> expect_silent()
...
p <- visreg2d(fit, "Wind", "Temp", trans = exp, plot.type = "gg")
print(p) |> expect_silent()
...
p <- visreg2d(fit, "Wind", "Temp", color = c("green", "blue"), plot.type = "gg")
print(p) |> expect_silent()
p <- visreg2d(fit, "Wind", "Temp", plot.type = "gg", xlab = "MyLabel", zlab = "MyTitle")
print(p) |> expect_silent()
...
p <- visreg2d(fit, x = "Wind", y = "Heat", plot.type = "gg")
print(p) |> expect_silent()
p <- visreg2d(fit, x = "Heat", y = "Wind", plot.type = "gg")
print(p) |> expect_silent()
...
p <- visreg2d(fit, "Heat", "Windy", plot.type = "gg")
print(p) |> expect_silent()
